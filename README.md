...
Full design rationale is in `docs/ingestion.md` (extraction) and `docs/query.md` (the future retrieval/ranking side).
...
- [`docs/architecture.md`](docs/architecture.md) — thin index into the docs below.
